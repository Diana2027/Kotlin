...
class WednesdayAdapter(private val data: ArrayList<DataWednesday>,
                       val onClick:(item: DataWednesday) -> Unit,
                       val onFavoriteClick:(index: Int) -> Unit, val isMainPage: Boolean)
    : RecyclerView.Adapter<WednesdayAdapter.ViewHolder>(), Filterable {

    private var dataFiltered: ArrayList<DataWednesday> = ArrayList()
        ...
        return object : Filter() {
            override fun performFiltering(charSequence: CharSequence?): FilterResults {
                ...
                if (charSearch.isEmpty()) {
                    ...
                    val resultList = ArrayList<DataWednesday>()
                    for (row in data) {
            ...
            override fun publishResults(p0: CharSequence?, results: FilterResults?) {
                dataFiltered = results?.values as ArrayList<DataWednesday>
