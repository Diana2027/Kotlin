...
class MondayAdapter(private val data: ArrayList<DataMonday>,
                    val onClick:(item: DataMonday) -> Unit,
                    val onFavoriteClick:(index: Int) -> Unit, val isMainPage: Boolean)
    : RecyclerView.Adapter<MondayAdapter.ViewHolder>(), Filterable {

    private var dataFiltered: ArrayList<DataMonday> = ArrayList()
        ...
        return object : Filter() {
            override fun performFiltering(charSequence: CharSequence?): FilterResults {
                ...
                if (charSearch.isEmpty()) {
                    ...
                    val resultList = ArrayList<DataMonday>()
                    for (row in data) {
            ...
            override fun publishResults(p0: CharSequence?, results: FilterResults?) {
                dataFiltered = results?.values as ArrayList<DataMonday>
