...
class TuesdayAdapter(private val data: ArrayList<DataTuesday>,
                     val onClick:(item: DataTuesday) -> Unit,
                     val onFavoriteClick:(index: Int) -> Unit, val isMainPage: Boolean)
    : RecyclerView.Adapter<TuesdayAdapter.ViewHolder>(), Filterable {

    private var dataFiltered: ArrayList<DataTuesday> = ArrayList()
        ...
        return object : Filter() {
            override fun performFiltering(charSequence: CharSequence?): FilterResults {
                ...
                if (charSearch.isEmpty()) {
                    ...
                    val resultList = ArrayList<DataTuesday>()
                    for (row in data) {
            ...
            override fun publishResults(p0: CharSequence?, results: FilterResults?) {
                dataFiltered = results?.values as ArrayList<DataTuesday>
