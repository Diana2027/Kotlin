...
class SundayAdapter(private val data: ArrayList<DataSunday>,
                    val onClick:(item: DataSunday) -> Unit,
                    val onFavoriteClick:(index: Int) -> Unit, val isMainPage: Boolean)
    : RecyclerView.Adapter<SundayAdapter.ViewHolder>(), Filterable {

    private var dataFiltered: ArrayList<DataSunday> = ArrayList()
        ...
        return object : Filter() {
            override fun performFiltering(charSequence: CharSequence?): FilterResults {
                ...
                if (charSearch.isEmpty()) {
                    ...
                    val resultList = ArrayList<DataSunday>()
                    for (row in data) {
            ...
            override fun publishResults(p0: CharSequence?, results: FilterResults?) {
                dataFiltered = results?.values as ArrayList<DataSunday>
