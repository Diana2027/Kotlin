...
class SaturdayAdapter(private val data: ArrayList<DataSaturday>,
                      val onClick:(item: DataSaturday) -> Unit,
                      val onFavoriteClick:(index: Int) -> Unit, val isMainPage: Boolean)
    : RecyclerView.Adapter<SaturdayAdapter.ViewHolder>(), Filterable {

    private var dataFiltered: ArrayList<DataSaturday> = ArrayList()
        ...
        return object : Filter() {
            override fun performFiltering(charSequence: CharSequence?): FilterResults {
                ...
                if (charSearch.isEmpty()) {
                    ...
                    val resultList = ArrayList<DataSaturday>()
                    for (row in data) {
            ...
            override fun publishResults(p0: CharSequence?, results: FilterResults?) {
                dataFiltered = results?.values as ArrayList<DataSaturday>
