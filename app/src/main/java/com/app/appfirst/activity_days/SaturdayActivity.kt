...
import com.app.appfirst.activity_favorite.FavoriteSaturdayActivity
...
class SaturdayActivity : AppCompatActivity() {
    ...
    var data = DataSaturday.initData()

    private val adapter by lazy {
        SaturdayAdapter(data, { item ->
    ...
    fun onFavorite(view: View) {
        Intent(this, FavoriteSaturdayActivity::class.java).also {
            it.putExtra(FavoriteSaturdayActivity.key, data)
            startActivity(it)
        }
    }
