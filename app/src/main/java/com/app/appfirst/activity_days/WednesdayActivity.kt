...
import com.app.appfirst.activity_favorite.FavoriteWednesdayActivity
...
class WednesdayActivity : AppCompatActivity() {
    ...
    var data = DataWednesday.initData()

    private val adapter by lazy {
        WednesdayAdapter(data, { item ->
    ...
    fun onFavorite(view: View) {
        Intent(this, FavoriteWednesdayActivity::class.java).also {
            it.putExtra(FavoriteWednesdayActivity.key, data)
            startActivity(it)
        }
    }
