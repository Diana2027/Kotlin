...
class DetailSaturdayAdapter(private val data: ArrayList<DetailSaturday>)
    : RecyclerView.Adapter<DetailSaturdayAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(val view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(detail: DetailSaturday) {
